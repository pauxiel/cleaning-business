    ...
    <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#34D399] to-[#10B981] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem]"
        />
      </div>
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Get a Free Quote</h2>
        <p className="mt-2 text-lg leading-8 text-gray-600">
          Contact us today for a free quote and learn more about how we can help transform your space!
        </p>
      </div>
